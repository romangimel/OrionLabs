  ...
  return (
    <div className="flex items-center gap-3 border-t border-[hsl(43_60%_70%_/_0.1)] pt-6 sm:justify-between">
      ...
      <button
        type="submit"
        disabled={disabled}
        className="group relative inline-flex h-12 flex-1 items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[#F5E6B0] to-[#C9A24A] px-6 text-sm font-semibold text-[#070514] shadow-[0_8px_30px_-6px_hsl(43_74%_66%_/_0.4)] transition-transform duration-300 hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(43_74%_78%)] focus-visible:ring-offset-2 focus-visible:ring-offset-[hsl(264_45%_8%)] motion-reduce:transform-none disabled:cursor-wait disabled:opacity-70 sm:flex-none sm:min-w-40"
      >
        ...
        {isFinalStep ? (
          ...
          <ArrowRight aria-hidden="true" className="relative z-10 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1 motion-reduce:transform-none" />
        )}
