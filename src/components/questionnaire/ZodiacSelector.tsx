  ...
  return (
    ...
    >
      <QuestionHeader
        ...
        asLegend
      />
      <div className="mt-5 grid grid-cols-3 gap-2.5 sm:gap-3 md:grid-cols-4 lg:mt-4">
