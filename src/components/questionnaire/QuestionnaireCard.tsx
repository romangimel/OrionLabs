...
export function QuestionnaireCard({
  ...
  return (
    <motion.section
      ...
      className="glass-strong relative mx-auto mt-7 w-full max-w-3xl overflow-hidden rounded-2xl p-5 shadow-[0_28px_90px_-38px_hsl(255_80%_2%_/_0.95)] sm:p-8 md:mt-9 md:p-10"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative">
        ...
        <div className="my-7 h-px bg-gradient-to-r from-[hsl(43_60%_70%_/_0.18)] via-[hsl(326_55%_65%_/_0.12)] to-transparent sm:my-8" />
