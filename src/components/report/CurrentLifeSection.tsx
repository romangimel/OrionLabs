...
export function CurrentLifeSection({ analysis }: CurrentLifeSectionProps) {
  return (
    ...
    >
      ...
      <aside className="relative mt-8 overflow-hidden border-l border-[hsl(43_60%_70%_/_0.38)] bg-[linear-gradient(90deg,hsl(43_74%_66%_/_0.07),transparent_75%)] px-5 py-5 sm:px-7 sm:py-6">
        <div
          aria-hidden="true"
        ...
        <p className="relative mt-4 font-serif text-2xl leading-snug text-gradient-cosmic sm:text-3xl">
          {analysis.forecast}
        </p>
      </aside>
    </ReportSection>
